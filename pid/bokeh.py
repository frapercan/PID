...
class bokeh(object):
    ...
    def difuminacion_gaussiana_fondo(self):
        ...
        imagen_superpixel.save("./imagenes/tmp/gauss/superpixelgrande.png")
        ...
        imagen_superpixel = PIL.Image.open("./imagenes/tmp/gauss/superpixelgrande.png").convert('L')
        ...
        io.imsave("./imagenes/tmp/gauss/aaa.png",array_superpixel_thumbnail_nivel_fondo)
        io.imsave("./imagenes/tmp/gauss/bbb.png",array_superpixel_thumbnail_nivel_medio1)
        io.imsave("./imagenes/tmp/gauss/bbb2.png",array_superpixel_thumbnail_nivel_medio2)
        io.imsave("./imagenes/tmp/gauss/bbb3.png",array_superpixel_thumbnail_nivel_medio3)
        io.imsave("./imagenes/tmp/gauss/ccc.png",array_superpixel_thumbnail_nivel_figura)

        imagen_superpixel_fondo = PIL.Image.open("./imagenes/tmp/gauss/aaa.png").convert('L')
        imagen_superpixel_medio1 = PIL.Image.open("./imagenes/tmp/gauss/bbb.png").convert('L')
        imagen_superpixel_medio2 = PIL.Image.open("./imagenes/tmp/gauss/bbb2.png").convert('L')
        imagen_superpixel_medio3 = PIL.Image.open("./imagenes/tmp/gauss/bbb3.png").convert('L')
        imagen_superpixel_figura = PIL.Image.open("./imagenes/tmp/gauss/ccc.png").convert('L')
        ...
        final1.save("./imagenes/tmp/gauss/gauss_adaptativo.png")
