...
s = superpixel.superpixel(nombre_thumbnail=thumbnail,profundidad=profundidad,nombre_salida="superpixel_angel2.png")
s.hacer_superpixel()

d = bokeh.bokeh(nombre_imagen,thumbnail,"superpixel_angel2.png")
